...
class JobNormalizer:
    ...
    def normalize(job: dict) -> dict:
        ...
        normalized["source_url"] = normalized.get("source_url") or normalized.get("application_url") or fallback_url
        normalized["application_url"] = normalized.get("application_url") or normalized.get("source_url") or fallback_url
